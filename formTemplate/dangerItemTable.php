...
// 處理公告欄資料
		 ...
		 */
		$js_par = "a";
		$js_body = "targetFormPHP = \"formTemplate/peopleRollFunction.php\";"  // set submit php
			 ...
			 . 	"});"
			 //.	"alert(arr);"
			 .	"var arr_result = JSON.stringify(arr);"
			 //.	"alert(arr_result);"
			 .	"jsonStr += '\"gb_data\":' + arr_result + ',';"  // javascript to json array, don't add " at [].
			 //  	count data number
			 . 	"jsonStr += '\"ga_number\":\"4\",';"  // element number
			 .	"jsonStr += '\"gb_unit\":\"10\",';"
