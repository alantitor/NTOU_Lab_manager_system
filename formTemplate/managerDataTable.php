...
// 處理公告欄資料
		...
		$js_body = "targetFormPHP = \"formTemplate/managerDataTableFunction.php\";"  // set submit php
			...
			.	"jsonStr += '\"gib_a\":' + JSON.stringify(arr_gib_a) + ',';"
			 ...
			 //.	"jsonStr += '\"gb_data\":' + arr_b_result + ',';"  // javascript to json array, don't add "dd
		 ...
		 $html  = "<div class=\"gen-title\">國立臺灣海洋大學安全衛生適用場所<br>管理資料調查表</div>"
			...
			.		"<td><input class='gen-box gen-textbox' id='gib-a4' type='number'></td>"
			.		"<td>每學期</td>"
			...
			.		"<td><input class='gen-box gen-textbox' id='gib-b4' type='number'></td>"
			.		"<td>每學期</td>"
			...
			.		"<td><input class='gen-box gen-textbox' id='gib-c4' type='number'></td>"
			.		"<td>每學期</td>"
			...
			.		"<td><input class='gen-box gen-textbox' id='gib-d4' type='number'></td>"
			.		"<td>每學期</td>"
			...
			.		"<td><input class='gen-box gen-textbox' id='gib-e4' type='number'></td>"
			.		"<td>每學期</td>"
			...
			.		"<td><input class='gen-box gen-textbox' id='gib-f4' type='number'></td>"
			.		"<td>每學期</td>"
			...
			.		"<td><input class='gen-box gen-textbox' id='gib-g4' type='number'></td>"
			.		"<td>每學期</td>"
			...
			.		"<td><input class='gen-box gen-textbox' id='gib-h4' type='number'></td>"
			.		"<td>每學期</td>"
			...
			.		"<td><input class='gen-box gen-textbox' id='gib-i4' type='number'></td>"
			.		"<td>每月</td>"
			...
			.		"<td><input class='gen-box gen-textbox' id='gib-k4' type='number'></td>"
			.		"<td>每月</td>"
			...
			.		"<td><input class='gen-box gen-textbox' id='gib-l4' type='number'></td>"
			.		"<td>每學期</td>"
